...
while($row = mysqli_fetch_assoc($result))
{
	...
	if($re == 0)
	{
	echo "<h1>You have successfully logged in as Admin</h1>";
	echo "<a href = 'Adminportal.html' > <h2>Lets get started!!</h2> </a>";
	}

	if($re == 1)
	{
	echo "<h1>Your username or password is invalid</h1>";
	echo "<a href = 'admin.html' > <h2>want to try again!!</h2> </a>";
	}
?>
